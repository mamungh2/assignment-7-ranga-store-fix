...
const showProducts = products => {
  for (const product of products) {
    ...
    div.classList.add("card-group", "single-product");
    div.innerHTML = `<div class="card","h-100">
        ...
        <div class="card-footer">
          <button onclick="addToCart(${product.price})" class="btn btn-success">
            Add to Cart
          </button>
...
// function to get innertext from dom element
